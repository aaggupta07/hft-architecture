...
namespace exchange {
auto BinaryProtocol::encode(const MarketEvent& event) -> std::array<std::byte, BUFFER_SIZE> {
...
MarketEvent BinaryProtocol::decode(const std::span<const std::byte> buffer) {
